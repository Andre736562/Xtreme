...
<section id="planes" class="py-5">
    <div class="container">
        <h2 class="display-6 fw-bold text-center mb-4">Planes</h2>

        <div class="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
            <div class="col">
                <div class="card h-100 text-center">
                    <div class="card-header">Plan Grupal</div>
                    <div class="card-body">
                        <h5 class="card-title">Entrena en grupo</h5>
                        <p class="card-text">Ideal para quienes buscan motivación y acompañamiento.</p>
                        <p class="display-6 fw-bold">$30 <span class="fs-6 text-muted">/mes</span></p>
                        <a href="#contacto" class="btn btn-primary">Inscribirme</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-100 text-center border-primary">
                    <div class="card-header bg-primary text-white">
                        Plan Mensual <span class="badge text-bg-warning ms-2">Popular</span>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Entrenamiento mensual</h5>
                        <p class="card-text">La opción más completa para entrenar de forma constante.</p>
                        <p class="display-6 fw-bold">$35 <span class="fs-6 text-muted">/mes</span></p>
                        <a href="#contacto" class="btn btn-dark">Inscribirme</a>
                    </div>
                </div>
            </div>
        </div>
...
<section id="horarios" class="py-5 bg-body-tertiary">
    <div class="container">
        <h2 class="display-6 fw-bold text-center mb-4">Horarios</h2>
